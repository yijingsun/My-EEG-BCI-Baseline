...
- Motor Imagery (MI, 运动想象)
    - BCI Competition IV Dataset IIa (BCICIV_2a_gdf)
        - Imagination of movement (4-class)：1-left hand, 2-right hand, 3-both feet, 4-tongue (EEG, Electroencephalogram, 脑电图, 有用信号)
        - EOG Estimate: 1-eyes open, 2-eyes closed, 3-eyes movement (EOG, Electroencephalogram, 眼电图, 噪声信号)
